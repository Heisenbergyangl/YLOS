...
static inode_t *fit_inode(inode_t *inode)
{
    ...
    super_block_t *super = get_super(inode->mount);
    assert(super);
    iput(inode);
    inode = super->iroot;
    inode->count++;
...
int inode_read(inode_t *inode, char *data, u32 len, off_t offset)
{
...
int inode_write(inode_t *inode, char *data, u32 len, off_t offset)
{
